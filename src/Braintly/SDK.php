...
use Braintly\Exceptions\Unauthorized;

/**
 * SDK class wrapper for Braintly UI communication
 *
 * @package BraintlySDK
 * @author Braintly
 */
class SDK {
	...
	public $curl_opts = array(
		CURLOPT_USERAGENT => "BRAINTLY-PHP-SDK-1.0.0",
	...
	private function execute($type='get', $url=null, $params=array()) {
		...
		// Build curl opts
		$opts = $this->curl_opts;
		if (strtoupper($type) == 'GET' && !empty($this->params)) {
